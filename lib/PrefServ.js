...
exports.createPrefs = function(){
	...
	if (!(PrefServ.has("extensions.agentSpoof.enabled"))) {
		...
		PrefServ.set("extensions.agentSpoof.totalRandomDesktopCount",0); //total number of available desktop profiles
		PrefServ.set("extensions.agentSpoof.totalRandomAllCount",0); //total number of available other profiles
	}
};
