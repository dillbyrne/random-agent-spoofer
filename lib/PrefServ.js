...
exports.createPrefs = function(){
	...
	if (!(PrefServ.has("extensions.agentSpoof.randomDesktopCount"))){
		PrefServ.set("extensions.agentSpoof.randomDesktopCount",0); //number of excluded desktop profiles
	}
	...
	if (!(PrefServ.has("extensions.agentSpoof.totalRandomDesktopCount"))){
		PrefServ.set("extensions.agentSpoof.totalRandomDesktopCount",222); //total number of available desktop profiles
	}
	if (!(PrefServ.has("extensions.agentSpoof.totalRandomAllCount"))){
		PrefServ.set("extensions.agentSpoof.totalRandomAllCount",320); //total number of available other profiles
	}
