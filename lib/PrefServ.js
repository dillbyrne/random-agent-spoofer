...
exports.createPrefs = function(){
	...
	if(!(PrefServ.has("extensions.agentSpoof.limitTab"))){ //set limitTab pref 
	...
	if(!(PrefServ.has("extensions.agentSpoof.fullWhiteList"))){
		PrefServ.set("extensions.agentSpoof.fullWhiteList","[{\"url\":\"play.google.com\"},{\"url\":\"s.ytimg.com\",\"options\":[\"canvas\"]},{\"url\":\"youtube.com\",\"options\":[\"canvas\",\"windowName\"]}]"); 
	}
	if(!(PrefServ.has("extensions.agentSpoof.siteWhiteList"))){
		PrefServ.set("extensions.agentSpoof.siteWhiteList","play.google.com,s.ytimg.com,youtube.com"); // site whitelist for url only lookups
	}
	if(!(PrefServ.has("extensions.agentSpoof.whiteListUserAgent"))){
		PrefServ.set("extensions.agentSpoof.whiteListUserAgent","Mozilla/5.0 (Windows NT 6.2; rv:37.0) Gecko/20100101 Firefox/37.0");
	}
