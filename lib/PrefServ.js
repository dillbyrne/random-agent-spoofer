...
exports.createPrefs = function(){
	...
	if(!(PrefServ.has("extensions.agentSpoof.fullWhiteList"))){
		PrefServ.set("extensions.agentSpoof.fullWhiteList","{\"whitelist\":[{\"url\":\"youtube.com\",\"canvas\":true}]}"); 
	}
	if(!(PrefServ.has("extensions.agentSpoof.siteWhiteList"))){
		PrefServ.set("extensions.agentSpoof.siteWhiteList","youtube.com"); // site whitelist
	}
	if(!(PrefServ.has("extensions.agentSpoof.whiteListUserAgent"))){
		PrefServ.set("extensions.agentSpoof.whiteListUserAgent","Mozilla/5.0 (Windows NT 6.2; rv:31.0) Gecko/20100101 Firefox/31.0");
	}
