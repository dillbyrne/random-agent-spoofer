...
exports.resetPrefs = function() {
	...
	PrefServ.reset('browser.safebrowsing.enabled');
	PrefServ.reset('browser.safebrowsing.downloads.enabled');
	PrefServ.reset('browser.safebrowsing.malware.enabled');
	PrefServ.reset('datareporting.healthreport.service.enabled');
	PrefServ.reset('datareporting.healthreport.uploadEnabled');
	PrefServ.reset('toolkit.telemetry.enabled');
};
