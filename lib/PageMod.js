...
exports.init = function() {
	...
	PageMod.PageMod({
		...
		onAttach: function(worker) {
			...
			// inject if script injection has been enabled and the default profile has not been selected
			if (PrefServ.getter("extensions.agentSpoof.scriptInjection") == true && PrefServ.getter("extensions.agentSpoof.uaChosen") != "default") {
