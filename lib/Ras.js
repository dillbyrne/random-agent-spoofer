...
exports.onUpgrade = function() {
	...
	if(PrefServ.getter('extensions.agentSpoof.fullWhiteList') === 
		...
		PrefServ.setter('extensions.agentSpoof.fullWhiteList','[{"url": "about:addons","options":["plugins"]}, {"url": "addons.mozilla.org"}, {"url": "play.google.com"}, {"url": "youtube.com"}]');
	...
	PrefServ.resetter('extensions.agentSpoof.siteWhiteList');
};
