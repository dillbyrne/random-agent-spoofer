...
exports.init = function() {
    ...
    Chrome.getHttpRequestObserver().register();
    ...
    if (PrefServ.getter("extensions.agentSpoof.enabled") == true){
        ...
        if(PrefServ.getter("extensions.agentSpoof.timeInterval") != "none" && PrefServ.getter("extensions.agentSpoof.uaChosen").slice(0,6) == "random"){
            startTimer();
        }else{
...
exports.onUnload = function(reason){
    ...
    //clear the timer
    Timer.clearTimer();
    Chrome.getHttpRequestObserver().unregister();
