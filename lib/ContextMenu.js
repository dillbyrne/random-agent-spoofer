...
var email = cm.Menu({
    ...
    items: [
        cm.Item({ image: Data.get("images/email_item.png"), label: localization.getString("anonbox_id"), data: "mail_anonbox" }),
        cm.Item({ image: Data.get("images/email_item.png"), label: localization.getString("kozmail_id"), data: "mail_kozmail" }),
        cm.Item({ image: Data.get("images/email_item.png"), label: localization.getString("mailcatch_id"), data: "mail_mailcatch" }),
        cm.Item({ image: Data.get("images/email_item.png"), label: localization.getString("yopmail_id"), data: "mail_yopmail" }),
        cm.Item({ image: Data.get("images/email_item.png"), label: localization.getString("mailinator_id"), data: "mail_mailinator" }),
        cm.Item({ image: Data.get("images/email_item.png"), label: localization.getString("dispostable_id"), data: "mail_dispostable" })
	]
});
