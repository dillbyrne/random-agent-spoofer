...
var toggle = cm.Item({
    ...
    label: localization.getString("disable_label_id"),
    data: "toggle"
});

var def = cm.Item({
    label: localization.getString("default_id"),
    image: Data.get("images/selected.png"),
    data: "default"
});

var rand = cm.Item({
    label: localization.getString("random_all_id"),
...
exports.toggleIconAndLabel = function(){
    ...
    if(PrefServ.getter("extensions.agentSpoof.enabled") == true){
        ...
        toggle.label = localization.getString("disable_label_id");
    
    }else{

        toggle.image = Data.get("images/off.png");
        toggle.label = localization.getString("enable_label_id");
    }
};
