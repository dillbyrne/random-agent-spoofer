...
function addMessageListeners(mm){
	mm.addMessageListener("RAS-frameOptions", function (message) {
		...
		params.windowName = PrefServ.getter('extensions.agentSpoof.windowName');
		params.profile = PrefServ.getter('extensions.agentSpoof.uaChosen');
		params.whiteListDisabled = PrefServ.getter('extensions.agentSpoof.whiteListDisabled');
