...
exports.init = function(){
    ...
    panel.on("show",function(){
        ...
        options[24] = PrefServ.getter("extensions.agentSpoof.screenSize");
        options[25] = PrefServ.getter("extensions.agentSpoof.webGl");
        options[26] = PrefServ.getter("extensions.agentSpoof.dnt");
        options[27] = PrefServ.getter("extensions.agentSpoof.referer");
        options[28] = PrefServ.getter("extensions.agentSpoof.authorization");
        options[29] = PrefServ.getter("extensions.agentSpoof.windowName");
    ...
    panel.port.on("refdd",function(value){
        ...
        PrefServ.setter("network.http.sendRefererHeader",parseInt(value));
    });
    ...
    panel.port.on("dntdd",function(value){
       ...
       if (value != "none"){
            ...
            PrefServ.setter("privacy.donottrackheader.value",parseInt(value));
        }
        else
            PrefServ.setter("privacy.donottrackheader.enabled",false);
