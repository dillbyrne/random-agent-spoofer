...
exports.init = function() {
	...
	panel.port.on('whitelist', function(fullWhiteList) {
...
function setupPanel() {
	...
	var prefs = [
		...
		[ 'setCheckBox', 'block_plugins', (PrefServ.getter('extensions.agentSpoof.blockPlugins')) ],
		[ 'setCheckBox', 'web_sockets', (PrefServ.getter('extensions.agentSpoof.webSocket')) ],
		[ 'setCheckBox', 'audio_context', (PrefServ.getter('extensions.agentSpoof.audioContext')) ],
		...
		[ 'setCheckBox', 'dom_user_timing', !(PrefServ.getter('dom.enable_user_timing')) ],
		...
		[ 'setCheckBox', 'spdy', !(PrefServ.getter('network.http.spdy.enabled')) ],
		...
		[ 'setCheckBox', 'show_notifications', (PrefServ.getter('extensions.jid1-AVgCeF1zoVzMjA@jetpack.show_notifications')) ],
		[ 'setCheckBox', 'show_context_menu', (PrefServ.getter('extensions.jid1-AVgCeF1zoVzMjA@jetpack.show_context_menu')) ],
		...
		[ 'setSelectedIndexByValue', 'spoofCoresdd', PrefServ.getter('extensions.agentSpoof.spoofCores') ],
		//[ 'setSelectedIndexByValue', 'tzdd', PrefServ.getter('extensions.agentSpoof.tzOffset') ], temporarily disabled, fix needed
		...
		[ 'setSelectedIndexByValue', 'cookiedd', PrefServ.getter('network.cookie.cookieBehavior').toString() ],
		[ 'setSelectedIndexByValue', 'cookielifedd', PrefServ.getter('network.cookie.lifetimePolicy').toString() ],
