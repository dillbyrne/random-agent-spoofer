...
exports.init = function(){
    ...
    function setupPanel(){
        ...
        panel.port.emit("setCheckBox","history",(PrefServ.getter("browser.sessionhistory.max_entries") === 2 ? true:false));
    ...
    panel.port.on("wlhelp",function(){
        Tabs.openURL("https://github.com/dillbyrne/random-agent-spoofer/wiki/");
    });
    ...
    panel.port.on("history",function(value){
        PrefServ.setter("browser.sessionhistory.max_entries",(value === true ? 2:50));
    });
