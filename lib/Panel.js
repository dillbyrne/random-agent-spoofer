...
exports.init = function(){
    ...
    function setupPanel(){
        ...
        panel.port.emit("setCheckBox","browser_pings",!(PrefServ.getter("browser.send_pings")));
        panel.port.emit("setCheckBox","clipboard_events",!(PrefServ.getter("dom.event.clipboardevents.enabled")));
        panel.port.emit("setCheckBox","context_menu_events",!(PrefServ.getter("dom.event.contextmenu.enabled")));
        panel.port.emit("setCheckBox","tracking_protection",(PrefServ.getter("privacy.trackingprotection.enabled")));
        panel.port.emit("setCheckBox","plugin_names",(PrefServ.getter("plugins.enumerable_names") === "" ? true:false));
        panel.port.emit("setCheckBox","css_visited_links",!(PrefServ.getter("layout.css.visited_links_enabled")));
