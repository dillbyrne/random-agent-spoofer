...
exports.init = function(){
    ...
    panel.on("show",function(){
        ...
        //it will be taken care of by the preference observer afterwards
    ...
    panel.port.on("whitelist",function(list,fullWhiteList,siteWhiteList){
        ...
        PageMod.setFullWhiteListProfile(PrefServ.getter("extensions.agentSpoof.fullWhiteList"));  

        console.log(fullWhiteList); 
        console.log(siteWhiteList); 
